      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex justify-end lg:justify-center">
          ...
          <Image
            ...
            width={900}
            height={700}
            className="w-full max-w-xl h-auto rounded-2xl shadow-[0_40px_100px_rgba(0,0,0,0.15)]"
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-20">
          ...
          <div className="relative pl-10 md:pl-12">
            <span className="absolute left-0 top-2 h-2 w-2 rounded-full bg-dark-choc/40"></span>
...
<div className="lg:col-span-6 lg:col-start-7 order-1 lg:order-2 lg:pl-6">
          ...
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-1 bg-dark-choc/5">
              <div className="bg-white p-12 md:p-16 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
                ...
                <h3 className="font-serif text-2xl text-dark-choc mb-5">Focused Approach</h3>
              ...
              <div className="bg-white p-12 md:p-16 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
                ...
                <h3 className="font-serif text-2xl text-dark-choc mb-5">No Jargon</h3>
                <p className="body-text text-near-black/60">
              ...
              <div className="bg-white p-12 md:p-16 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
                ...
                <h3 className="font-serif text-2xl text-dark-choc mb-5">Results-Driven</h3>
                <p className="body-text text-near-black/60">
              ...
              <div className="bg-white p-12 md:p-16 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
                ...
                <h3 className="font-serif text-2xl text-dark-choc mb-5">Long-Term Thinking</h3>
                <p className="body-text text-near-black/60">
